...
def train_forecast_model():
    ...
    # Use a 7-day forecast period
    forecast_days = 7
    print(f"Using {forecast_days}-day forecast period")
    ...
    plt.plot(forecast_df['ds'], forecast_df['y'], 'b-', label='Historical', linewidth=2)
    ...
    plt.legend(loc='best')
    plt.title('Cryptocurrency Sentiment Forecast (2021 Data)')
    plt.xlabel('Date')
